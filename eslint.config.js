...
export default [
  ...
  js.configs.recommended,
  {
    ...
    rules: {
      ...
      'import/no-unresolved': ['error', { ignore: ['^@modelcontextprotocol/sdk', '^hono'] }],
      'import/no-extraneous-dependencies': ['error', { devDependencies: ['tests/**/*.test.js', 'specs/**', 'scripts/**', 'c8.config.json', 'eslint.config.js'], optionalDependencies: true }],
      'import/order': 'off',
