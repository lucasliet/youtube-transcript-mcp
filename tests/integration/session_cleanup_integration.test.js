...
describe('Session Cleanup Integration', () => {
  ...
  it('should manage session lifecycle correctly', () => {
    ...
    const mockTransport1 = { sessionId: 'session-1', close: () => Promise.resolve() }
    const mockTransport2 = { sessionId: 'session-2', close: () => Promise.resolve() }
  ...
  it('should handle individual session cleanup', () => {
    const mockTransport = { sessionId: 'test-session', close: () => Promise.resolve() }
